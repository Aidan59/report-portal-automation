...
public class DashboardPage {
    ...
    private final By deleteDashboardBtn = By.cssSelector("#app > div > div > div > div > div.layout__content--y1ANI > div.scrollWrapper__scroll-component--L3JSO > div.scrollWrapper__scrolling-content--FGvAS.scrollWrapper__with-footer--lyezV > div > div.layout__page-container--O1S09 > div > div.pageLayout__page-content--DCfUt > div > div.dashboardItemPage__buttons-container--Y1y1d > div:nth-child(2) > button:nth-child(3)");
    private final By deleteConfirmDashboardBtn = By.cssSelector("#modal-root > div > div.modalLayout__scrolling-content--z2e1T > div > div:nth-child(1) > span > div > div.modalFooter__modal-footer--yasOK > div.modalFooter__buttons-block--Bplno > div:nth-child(2) > button");
    ...
    private final By addFilterBtn = By.cssSelector("#modal-root > div > div.widgetWizardModal__scrolling-content--WypTy > div > div.scrollWrapper__scrolling-content--FGvAS > div > div.widgetWizardContent__widget-wizard-content--InQJb > div.wizardControlsSection__wizard-controls-section--v0bBW > div.wizardControlsSection__controls-wrapper--hC20C > form > div.filtersControl__filters-control--WRwmL > div.filtersActionPanel__filters-header--ZohEG > button");
    private final By filterName = By.cssSelector("#modal-root > div > div.widgetWizardModal__scrolling-content--WypTy > div > div.scrollWrapper__scrolling-content--FGvAS > div > div.widgetWizardContent__widget-wizard-content--InQJb > div.wizardControlsSection__wizard-controls-section--v0bBW > div.wizardControlsSection__controls-wrapper--hC20C > form > div > div > div.filterAdd__filter-add-custom-block--Mort4 > div > input");
    private final By launchName = By.cssSelector("#modal-root > div > div.widgetWizardModal__scrolling-content--WypTy > div > div.scrollWrapper__scrolling-content--FGvAS > div > div.widgetWizardContent__widget-wizard-content--InQJb > div.wizardControlsSection__wizard-controls-section--v0bBW > div.wizardControlsSection__controls-wrapper--hC20C > form > div > div > div.addEditFilter__filters-block--STpaI > div.entitiesGroup__entities-group--NJ7Ny > div.entitiesGroup__entity-item--iVJ16 > div > div.fieldFilterEntity__field-filter-entity--PIyev.fieldFilterEntity__small--iXpHa > div > div > input");
    private final By submitFilterBtn = By.cssSelector("#modal-root > div > div.widgetWizardModal__scrolling-content--WypTy > div > div.scrollWrapper__scrolling-content--FGvAS > div > div.widgetWizardContent__widget-wizard-content--InQJb > div.wizardControlsSection__wizard-controls-section--v0bBW > div.wizardControlsSection__controls-wrapper--hC20C > form > div > div > div.addEditFilter__filters-block--STpaI > div.addEditFilter__filter-buttons-block--nlgGV > button.bigButton__big-button--BmG4Q.addEditFilter__button-inline--eGR3g.bigButton__color-booger--EpRlL");
    ...
    public void clickAddWidget(String widgetTitle) {
        try {
            ...
            if (!wait.until(ExpectedConditions.elementToBeClickable(radioBtnFilterFirst)).isDisplayed()){
                addNewFilter();
            }
    ...
    private void addNewFilter() throws InterruptedException {
        wait.until(ExpectedConditions.elementToBeClickable(addFilterBtn)).click();
        wait.until(ExpectedConditions.elementToBeClickable(filterName)).sendKeys("Test Filter");
        wait.until(ExpectedConditions.elementToBeClickable(launchName)).sendKeys("Test Filter");
        Thread.sleep(3000);
        wait.until(ExpectedConditions.elementToBeClickable(submitFilterBtn)).click();
    }

    public void deleteDashboard() {
        try {
            wait.until(ExpectedConditions.elementToBeClickable(deleteDashboardBtn)).click();
            Thread.sleep(3000);
            wait.until(ExpectedConditions.elementToBeClickable(deleteConfirmDashboardBtn)).click();
            Thread.sleep(3000);
        } catch (InterruptedException e) {
            throw new RuntimeException(e);
        }
